...
<body>
    ...
    <main class="container py-4">
            ...
            <div class="sg-preview-wrap">
                <div class="sg-preview-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <a href="#" class="btn btn-success btn-sm"><i class="bi bi-file-earmark-pdf"></i> Export
                            PDF</a>
        ...
        <section class="sg-section" id="tabel">
            ...
            <p class="text-muted mb-4">DataTables dengan AdminLTE styling. Search input di card-tools, action button
                group di kolom aksi.</p>
            ...
            <div class="sg-code mt-3"><code>&lt;div class="card"&gt;
                    ...
                    &lt;div class="card-body p-0"&gt;
                    &lt;table class="table table-striped table-hover align-middle mb-0"&gt;
                    &lt;thead&gt;&lt;tr&gt;&lt;th&gt;No&lt;/th&gt;&lt;th&gt;Nama&lt;/th&gt;&lt;th
                    class="text-center"&gt;Aksi&lt;/th&gt;&lt;/tr&gt;&lt;/thead&gt;
                    &lt;tbody&gt;...&lt;/tbody&gt;
                    &lt;/table&gt;
                    &lt;/div&gt;
        ...
        <section class="sg-section" id="form">
            ...
            <p class="text-muted mb-4">Form create/edit menggunakan kelas Bootstrap <code>form-control</code>,
                <code>form-select</code>, dan <code>form-check</code>.</p>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <div class="card sg-inner-card">
                        ...
                        <div class="card-body">
                            <p class="mb-0">Konten di dalam <code>.card-body</code>. Tools di
                                <code>.card-tools</code> di dalam <code>.card-header</code>.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
