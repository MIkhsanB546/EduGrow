...
{{-- Header style guide --}}
    ...
    <main class="container py-4">
        ...
        {{-- Bagian 2: Tipografi dan contoh teks --}}
        <!-- ============================================================ -->
        <!-- 2. TIPOGRAFI -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 3: Contoh tombol aksi dan grup tombol --}}
        <!-- ============================================================ -->
        <!-- 3. TOMBOL -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 4: Struktur kartu AdminLTE --}}
        <!-- ============================================================ -->
        <!-- 4. KARTU ADMINLTE -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 5: Contoh tabel DataTables --}}
        <!-- ============================================================ -->
        <!-- 5. TABEL -->
        <!-- ============================================================ -->
...
&lt;/div&gt;</code></div>
        ...
        {{-- Bagian 6: Navigasi sidebar Admin dan Guru --}}
        <!-- ============================================================ -->
        <!-- 6. SIDEBAR -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 7: Contoh form create/edit --}}
        <!-- ============================================================ -->
        <!-- 7. FORM -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 8: Inspirasi desain dashboard --}}
        <!-- ============================================================ -->
        <!-- 8. INSPIRASI -->
        <!-- ============================================================ -->
