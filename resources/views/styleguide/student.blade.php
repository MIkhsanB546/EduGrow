...
{{-- Header style guide --}}
    ...
    <main class="container py-4">
        ...
        {{-- Bagian 3: Contoh tombol dan variasinya --}}
        <!-- ============================================================ -->
        <!-- 3. TOMBOL -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 4: Contoh kartu statistik dan materi --}}
        <!-- ============================================================ -->
        <!-- 4. KARTU -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 5: Navigasi navbar siswa --}}
        <!-- ============================================================ -->
        <!-- 5. NAVIGASI -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 6: Contoh form login, register, dan edit profil --}}
        <!-- ============================================================ -->
        <!-- 6. FORM -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 7: Daftar ikon Bootstrap Icons --}}
        <!-- ============================================================ -->
        <!-- 7. IKON -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 8: Inspirasi desain dari platform lain --}}
        <!-- ============================================================ -->
        <!-- 8. INSPIRASI DESAIN -->
        <!-- ============================================================ -->
        ...
        {{-- Bagian 9: Tabel breakpoint responsive --}}
        <!-- ============================================================ -->
        <!-- 9. RESPONSIVE -->
        <!-- ============================================================ -->
