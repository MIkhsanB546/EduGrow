                    ...
                    <div class="card-body">
                        <table id="tingkatTable" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('dashboard.tingkat-kesulitan.edit', $tingkat->id_tingkat) }}"
                                                    class="btn btn-warning" title="Edit">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <form
                                                    action="{{ route('dashboard.tingkat-kesulitan.destroy', $tingkat->id_tingkat) }}"
                                                    method="post" class="d-inline"
                                                    onsubmit="return confirm('Yakin ingin menghapus tingkat kesulitan ini?')">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-3">Belum ada tingkat kesulitan
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
