...
@section('content')
    ...
    <a href="{{ route('siswa.materi.index') }}"
        class="inline-flex items-center text-sm text-gray-500 hover:text-gray-900 transition-colors mb-4">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @if ($materi->file_materi)
                            ...
                            <a href="{{ \Illuminate\Support\Facades\Storage::url($materi->file_materi) }}"
                                class="inline-flex items-center px-5 py-2.5 bg-indigo-50 text-indigo-700 rounded-xl text-sm font-semibold hover:bg-indigo-100 transition-colors">
